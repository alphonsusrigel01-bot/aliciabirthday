...
const galaxyParameters = {
  ...
  randomness: 0.2,
  randomnessPower: 20,
  insideColor: new THREE.Color(0xd65),
...
const ringTexts = [
  'Universe of love From Mas Igel.',//untuk deskripsi planet layer 1
  "Happy 26th my fiance",//untuk deskripsi planet layer 2
  "♡Happy Girlfriend day♡",//untuk deskripsi planet layer 3
  "06/02/2026",//untuk deskripsi planet layer 4
...
function createTextRings() {
  ...
  for (let i = 0; i < numRings; i++) {
    ...
    ctx.shadowColor = '#c57df5';
    ctx.shadowBlur = 18;
    ctx.lineWidth = 7;
    ctx.strokeStyle = '#544848';
    ctx.strokeText(fullText, 0, textureHeight * 0.82); 


    ctx.shadowColor = '#f86aba';
    ctx.shadowBlur = 24;
    ctx.fillStyle = '#fff';
...
function preloadGalaxyAudio() {
  const audioSources = [
   "https://youtu.be/aMX2JOzKoDY?si=Tq19LUgYO_lFRU_K"
  ];
...
function createHintText() {
  ...
  const context = canvas.getContext('2d');
  const fontSize = 50;
  const text = 'Happy Birthday Lovely';
